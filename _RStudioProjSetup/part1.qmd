...
::: {.content-visible when-meta="instructor_given"}
...
By default, the ***Files*** tab shows file extensions but it does not show hidden files.  If you click on ***More -\> Show Hidden Files***, you will see the hidden folder ***.Rproj.user*** -- this is not a folder you will use in this class.
...
This topic is, in this author's opinion, one of the most frustrating topic in R.  Compared to most other programming languages (e.g., C++, Javascript), R handling of working directories makes it harder to share projects.
...
![RStudio will prompt you to install packages used in scripts](images/RSProj_InstallPackage.png){#fig-rstudio_prompt .fs}
...
In future lessons we will use the Help tab to find information about functions.

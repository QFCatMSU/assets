...
-   **Push changes to your GitHub repository**
    ...
    -   Modify (add, remove, edit) any file in your RStudio Project (@sec-modify)

    -   Add a commit message (@sec-commit_message)

    -   Commit changes to Project (@sec-commit)

    -   Push changes to GitHub (@sec-push)

-   **Pull changes from a GitHub repository**

    -   Get URL of your GitHub repository (@sec-get_link)

    -   Create a new RStudio Project and link it to your GitHub Repository (@sec-new_repo)

    -   Make change to the original Git repository and Push to GitHub (@sec-update)

    -   Pull changes from GitHub to the copy of your repository (@sec-pull)
...
1.  Make changes (add/modify/delete) to files in your project (***Unstaged Changes***) 
...
### Make changes to your project (add, delete, or modify) {#sec-modify}

The images below (@fig-GitTab) shows an example project in which the following files were added:
...
### Approve changes Unstaged –\> Staged {#sec-stage}
...
### Add information about these change (Commit Message) {#sec-commit_message}
...
### Save the approved changes (Commit) {#sec-commit}
...
### Sending the newest Commits to GitHub (Push) {#sec-push}
...
[02-GitHub_Setup.html#sec-verifyGitHub](02-GitHub_Setup.html#sec-verifyGitHub)
...
### Syncing your project from GitHub {#sec-get_link}
...
### Link to an existing GitHub Repository  {#sec-new_repo}
...
## Updating your Git and GitHub repositories {#sec-update}
...
### Getting updates (Pull) from GitHub {#sec-pull}
...
B\) Commit the changes to your repository with a Commit message [that clearly states all the changes you made]{.hl}.
...
## Extension: Downloading GitHub repositories

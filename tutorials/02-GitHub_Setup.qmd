...
3\) The third line sends (***Push***) your project to the GitHub repository (***origin***).  There is a good chance that GitHub will ask you to authenticate at this point using the GCM (@sec-auth) \<does main work here?
